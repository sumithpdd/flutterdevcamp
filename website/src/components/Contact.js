        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4">
              <div className="contact-info-one__single">
                <div className="contact-info-one__icon">
                  <i className="Flutter DevCamp |-icon-manager"></i>
                </div>
            ...
            <div className="col-lg-4">
              <div className="contact-info-one__single">
                <div className="contact-info-one__icon">
                  <i className="Flutter DevCamp |-icon-placeholder"></i>
                </div>
            ...
            <div className="col-lg-4">
              <div className="contact-info-one__single">
                <div className="contact-info-one__icon">
                  <i className="Flutter DevCamp |-icon-contact"></i>
                </div>
                <h2 className="contact-info-one__title">Contact Info</h2>
                <p className="contact-info-one__text">
                  needhelp@Flutter DevCamp |.com <br />
                  444 888 0000 <br /> &nbsp;
                </p>
              </div>
            </div>
